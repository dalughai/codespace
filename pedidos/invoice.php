...
function addReglement( $mode )
{
    ...
    $this->SetFont( "Arial", "B", 10);
    $this->Cell(10,4, "TIPO DE PAGO", 0, 0, "C");
...
function addEcheance( $date )
{
    ...
    $this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
    $this->SetFont( "Arial", "B", 10);
    $this->Cell(10,4, "FECHA FACTURA", 0, 0, "C");
    $this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
    $this->SetFont( "Arial", "", 10);
    $this->Cell(10,5,$date, 0,0, "C");
}
...
function addNumTVA($tva)
{
    ...
    $this->Cell(40, 4, "ORIGEN FACTURA", '', '', "C");
    $this->SetFont( "Arial", "", 10);
...
{
    $this->SetFont( "Arial", "", 10);
    $length = $this->GetStringWidth( "IMPUESTOS : " . $remarque );
    $r1  = 10;
    $r2  = $r1 + $length;
    $y1  = $this->h - 45.5;
    $y2  = $y1+5;
    $this->SetXY( $r1 , $y1 );
    $this->Cell($length,4, "IMPUESTOS : " . $remarque);
}
...
function addCadreEuros($base, $iva, $precio_final,$articulos)
{
    $r1  = $this->w - 70;
    $r2  = $r1 + 60;
    $y1  = $this->h - 40;
    ...
    $this->Cell(22,4, "ARTICULOS", 0, 0, "C");
    $this->SetFont( "Arial", "", 8);
    $this->SetXY( $r1+42, $y1 );
    $this->Cell(15,4, "", 0, 0, "C");
    $this->SetFont( "Arial", "B", 7);
    $this->SetXY( $r1, $y1+5 );
    $this->Cell(20,4, "BASE", 0, 0, "C");
    $this->Cell(25,4, " $base", 0, 0, "C");
    $this->Cell(20,4, " $articulos", 0, 0, "C");
    $this->SetXY( $r1, $y1+10 );
    $this->Cell(20,4, "IVA", 0, 0, "C");
    $this->Cell(25,4, " $iva", 0, 0, "C");
    $this->SetXY( $r1, $y1+15 );
    $this->Cell(20,4, "PRECIO FINAL", 0, 0, "C");
     $this->Cell(25,4, " $precio_final", 0, 0, "C");
}
