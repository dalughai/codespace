...
$sql = "SELECT * FROM productos WHERE id = $id_producto";
    ...
    if ($resultado) {
        ...
        $sql = "select categorias.nombre, categorias.id as id_categoria from productos join categorias on categorias.id = productos.id_categoria where productos.id = '$id_producto'";
